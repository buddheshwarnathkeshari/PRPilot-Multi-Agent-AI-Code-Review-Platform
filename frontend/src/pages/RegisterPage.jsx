      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: '28rem' }}>
        ...
        <div className="glass-panel w-full flex flex-col relative" style={{ padding: '3rem 2.5rem', gap: '2rem', animation: 'slideUp 0.5s ease-out forwards', zIndex: 1 }}>
          <div className="text-center flex flex-col items-center gap-2">
            <img src="/PRPilot-logo.jpg" alt="PRPilot" style={{ height: '56px', width: '56px', objectFit: 'cover', borderRadius: '50%', marginBottom: '0.5rem' }} />
            ...
            <p className="text-sm m-0" style={{ color: 'var(--text-secondary)' }}>Get started with PRPilot today</p>
          </div>
